...
contains
  ...
  subroutine trace_finalise(debug,rank,check_stack)
    ...
    if (.not.present(check_stack))then
       ...
       print*, "Error: trace array mismatch"
       stop
    end if
    end if
...
!    call trace_entry("IO_STRING_TO_LOWER")
  ...
  subroutine trace_IO(rank,subs_list,time_list,call_list)
    ...
    open(unit=file_id,file="profile."//rank_char//".pop",RECL=8192,form="FORMATTED",status="UNKNOWN")

    write(file_id,*) "+==================================================================================+"
    write(file_id,*) '|        888b     d888  .d8888b.          8888888b.   .d88888b.  8888888b.         |'
    write(file_id,*) '|        8888b   d8888 d88P  Y88b         888   Y88b d88P" "Y88b 888   Y88b        |'
    write(file_id,*) '|        88888b.d88888 888    888         888    888 888     888 888    888        |'
    write(file_id,*) '|        888Y88888P888 888                888   d88P 888     888 888   d88P        |'
    write(file_id,*) '|        888 Y888P 888 888                8888888P"  888     888 8888888P"         |'
    write(file_id,*) '|        888  Y8P  888 888    888         888        888     888 888               |'
    write(file_id,*) '|        888   "   888 Y88b  d88P         888        Y88b. .d88P 888               |'
    write(file_id,*) '|        888       888  "Y8888P" 88888888 888         "Y88888P"  888               |'
    write(file_id,*) "+==================================================================================+"
    write(file_id,*) "|                                                                                  |"
